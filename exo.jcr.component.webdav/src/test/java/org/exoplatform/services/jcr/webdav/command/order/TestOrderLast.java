...
public class TestOrderLast extends OrderPatchTest
{
   ...
   public void testOrderLast2() throws Exception
   {
      ...
      String xml =
         "" + "<D:orderpatch xmlns:D=\"DAV:\">" + "<D:order-member>" + "<D:segment>n2</D:segment>"
            + "<D:position><D:last/></D:position>" + "</D:order-member>" + "<D:order-member>"
            + "<D:segment>n0</D:segment>" + "<D:position><D:last/></D:position>" + "</D:order-member>"
            + "</D:orderpatch>";
