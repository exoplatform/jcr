   ...
   extends AbstractIndex
{
   ...
   /**
    * Overwrites the default implementation by adding the documents to a pending list and commits the
   ...
   /**
    * Overwrites the default implementation to remove the document from the pending list if it is
   ...
   /**
    * Overwrites the implementation in {@link AbstractIndex} to trigger commit of pending documents
    * to index.
    * 
   ...
   /**
    * Overwrites the implementation in {@link AbstractIndex} to commit pending documents.
    * 
    * @param optimize
   ...
   /**
    * Sets a new buffer size for pending documents to add to the index. Higher values consume more
    * memory, but help to avoid multiple index cycles when a node is changed / saved multiple times.
    * 
    * @param size
    *          the new buffer size.
    */
