...
/**
 * Implements a variant of the lucene class {@link org.apache.lucene.search.RangeQuery}. This class
...
public class RangeQuery extends Query implements Transformable
{
    ...
    */
   private static final Log log = ExoLogger.getLogger(RangeQuery.class);

   /**
    * The lower term. May be <code>null</code> if <code>upperTerm</code> is not <code>null</code>.
    */
   private Term lowerTerm;

   /**
    * The upper term. May be <code>null</code> if <code>lowerTerm</code> is not <code>null</code>.
    */
   ...
   /**
    * The rewritten range query or <code>null</code> if the range spans more than
    * {@link org.apache.lucene.search.BooleanQuery#maxClauseCount} terms.
    */
   private Query stdRangeQuery;

   /**
    * Creates a new RangeQuery. The lower or the upper term may be <code>null</code>, but not both!
    * 
    * @param lowerTerm
    *          the lower term of the interval, or <code>null</code>
    * @param upperTerm
    *          the upper term of the interval, or <code>null</code>.
    * @param inclusive
    *          if <code>true</code> the interval is inclusive.
    */
   ...
   /**
    * Tries to rewrite this query into a standard lucene RangeQuery. This rewrite might fail with a
    * TooManyClauses exception. If that happens, we use our own implementation.
    * 
    * @param reader
    *          the index reader.
    ...
    * 
    * @param searcher
    *          the searcher to use for the <code>Weight</code>.
   ...
   private class RangeQueryWeight extends AbstractWeight
   {
      ...
      /**
       * Creates a new <code>RangeQueryWeight</code> instance using <code>searcher</code>.
       * 
       * @param searcher
   ...
   private final class RangeQueryScorer extends Scorer
   {
      ...
      /**
       * Compares the <code>text</code> with the <code>other</code> String. This implementation
       * behaves like {@link String#compareTo(Object)} but also respects the
       * {@link RangeQuery#transform} property.
       * 
       * @param text
       *          the text to compare to <code>other</code>. The transformation function is applied to
       *          this parameter before it is compared to <code>other</code>.
       * @param other
       *          the other String.
       * @param offset
       *          start comparing the two strings at <code>offset</code>.
       * @return see {@link String#compareTo(Object)}. But also respects {@link #transform}.
       */
