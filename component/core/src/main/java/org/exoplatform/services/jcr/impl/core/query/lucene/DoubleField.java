...
/**
 * The <code>DoubleField</code> class is a utility to convert double values into <code>String</code>
 * values that are lexicographically ordered according to the double value.
 */
