...
/**
 * This class indicates the lucene index format that is used. Version 1 formats do not have the
 * <code>PROPERTIES_SET</code> lucene fieldname and queries assuming this format also run on newer
 * versions. When the index is recreated from scratch, the Version 2 format will automatically be
 * used. This format is faster certain queries, so if the index does not contain
 * <code>PROPERTIES_SET</code> fieldname and re-indexing is an option, this is advisable. Existing
