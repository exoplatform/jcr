 ...
 * <code>ReadOnlyIndexReader</code> will always show all documents that have not
...
class ReadOnlyIndexReader extends RefCountingIndexReader
{
    ...
    * {@link DocId#NULL} if <code>n</code> does not have a parent (<code>n</code>
    * is the root node).
    * 
   ...
   /**
    * Wraps the underlying <code>TermDocs</code> and filters out documents marked
    * as deleted.<br/>
