...
/**
 * Implements <code>Date</code> &lt;-&gt; <code>String</code> conversions in a way that the
 * resulting <code>String</code> is suitable for indexing and sorting.
 */
public class DateField
{
    ...
    */
   private static final int DATE_LEN = Long.toString(1000L * 365 * 24 * 60 * 60 * 3000, Character.MAX_RADIX).length();
   ...
   /**
    * Converts a Date to a string suitable for indexing. This method will throw a RuntimeException if
    * the date specified in the method argument is before 30 BC or after 3189.
    */
   ...
   /**
    * Converts a millisecond time to a string suitable for indexing. Supported date range is: 30 BC -
    * 3189
    */
