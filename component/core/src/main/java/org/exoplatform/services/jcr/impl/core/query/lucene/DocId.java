...
/**
 * Implements a document id which can be based on a Node uuid or a lucene document number.
 */
abstract class DocId
{

   /**
    * Indicates a null DocId. Will be returned if the root node is asked for its parent.
    */
   ...
   /**
    * Returns the document number of this <code>DocId</code>. If this id is invalid <code>-1</code>
    * is returned.
    * 
    * @param reader
    *          the IndexReader to resolve this <code>DocId</code>.
    * @return the document number of this <code>DocId</code> or <code>-1</code> if it is invalid
    *         (e.g. does not exist).
    * @throws IOException
   ...
   /**
    * Applies an offset to this <code>DocId</code>. The returned <code>DocId</code> may be the same
    * as <code>this</code> if this <code>DocId</code> does not need to know about an offset.
    * 
    * @param offset
   ...
   /**
    * Returns <code>true</code> if this <code>DocId</code> is valid against the set of
    * <code>deleted</code> documents; otherwise <code>false</code>.
    * 
    * @param deleted
    *          the deleted documents.
    * @return <code>true</code> if this <code>DocId</code> is not delted; otherwise
    *         <code>false</code>.
    */
   ...
   private static final class UUIDDocId extends DocId
   {
       ...
       *           if the <code>uuid</code> is malformed.
       */
      ...
      /**
       * This implementation will return <code>this</code>. Document number is not known until
       * resolved in {@link #getDocumentNumber(MultiIndexReader)}.
       * 
       * @inheritDoc
       */
      DocId applyOffset(int offset)
