 ...
 * @version $Id: TransientValueDataReader.java 34801 2009-07-31 15:44:50Z dkatayev $
 */
public class TransientValueDataReader
{
    ...
    */
   public TransientValueDataReader(FileCleaner fileCleaner, int maxBufferSize, ReaderSpoolFileHolder holder)
   {
   ...
   public TransientValueData read(ObjectReader in) throws UnknownClassIdException, IOException
   {
      ...
      if (isByteArray)
      {
         ...
         in.readFully(data);
         return new TransientValueData(orderNumber, data, null, null, fileCleaner, maxBufferSize, tempDirectory, true);
      ...
      else
      {
         ...
         if (sf == null)
         {
            ...
            holder.put(id, sf);
            return new TransientValueData(orderNumber, null, null, sf, fileCleaner, maxBufferSize, tempDirectory, true);
         }
         else
         {
