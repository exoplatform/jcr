   ...
   extends QueryNode
{
   ...
   /**
    * Creates a new <code>NAryQueryNode</code> with a reference to a parent {@link QueryNode}.
    * 
    * @param parent
    *          the parent node.
    */
   ...
   /**
    * Creates a new <code>NAryQueryNode</code> with a reference to a parent {@link QueryNode} and
    * initial <code>operands</code>.
    * 
    * @param parent
    *          the parent node.
    * @param operands
    *          child nodes of this <code>NAryQueryNode</code>.
    */
    ...
    * 
    * @param operand
    *          the child {@link QueryNode} to add.
    */
    ...
    * @param operand
    *          the child to remove.
    * @return <code>true</code> if the operand was in the list of child nodes and has been removed;
    *         <code>false</code> if this node does not contain <code>operand</code> as a child node.
    */
   ...
   /**
    * Helper class to accept a <code>visitor</code> for all operands of this
    * <code>NAryQueryNode</code>.
    * 
    * @param visitor
