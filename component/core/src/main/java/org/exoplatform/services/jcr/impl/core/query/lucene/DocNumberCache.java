...
final class DocNumberCache
{
    ...
    */
   private static final Log log = ExoLogger.getLogger(DocNumberCache.class);
   ...
   /**
    * Creates a new <code>DocNumberCache</code> with a limiting <code>size</code>.
    * 
    * @param size
    *          the cache limit.
    */
   ...
   /**
    * Puts a document number into the cache using a uuid as key. An entry is only overwritten if the
    * according reader is younger than the reader associated with the existing entry.
    * 
    * @param uuid
    *          the key.
    * @param reader
    *          the index reader from where the document number was read.
    * @param n
    *          the document number.
    */
   ...
   /**
    * Returns the cache entry for <code>uuid</code>, or <code>null</code> if no entry exists for
    * <code>uuid</code>.
    * 
    * @param uuid
    *          the key.
