...
class DerefQuery extends Query
{
   ...
   /**
    * The nameTest to apply on target node, or <code>null</code> if all target nodes should be
    * selected.
    */
   ...
   /**
    * Creates a new <code>DerefQuery</code> based on a <code>context</code> query.
    * 
    * @param context
    ...
    *          the name of the reference property.
    * @param nameTest
    *          a name test or <code>null</code> if any node is selected.
    */
   ...
   private class DerefWeight implements Weight
   {
      ...
      /**
       * Creates a new <code>DerefWeight</code> instance using <code>searcher</code>.
       * 
       * @param searcher
