   ...
   implements CharSequence, Comparable<OffsetCharSequence>, TransformConstants
{
    ...
    *          the offset
    * @param base
    *          the base CharSequence
    * @param transform
    *          how the <code>base</code> char sequence is tranformed.
    */
    ...
    * @return as defined in {@link String#compareTo(Object)} but also takes {@link #transform} into
    *         account.
    */
   public int compareTo(OffsetCharSequence o)
   {
      OffsetCharSequence other = o;
      int len1 = length();
