...
/**
 * This is an implementation of Hits which starts with marking hits in an ArrayHits instance and
   ...
   implements Hits
{
    ...
    */
   private static final Log log = ExoLogger.getLogger(AdaptingHits.class);
   ...
   /**
    * The maximum doc number in hits. Used to calculate the expected BitSetHits memory footprint.
    */
   private int maxDoc;

   /**
    * The total number of hits. Used to calculate the memory footprint of the initial ArrayHits
    * instance.
    */
