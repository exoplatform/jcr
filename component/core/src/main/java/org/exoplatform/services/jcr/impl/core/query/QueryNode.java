...
/**
 * Implements an abstract base class for nodes of a query tree that represents a query. The query
 * tree is independent from the query syntax which is used to search the repository.
 */
public abstract class QueryNode
{
   ...
   /**
    * References the parent of this <code>QueryNode</code>. If this is the root of a query tree, then
    ...
    * 
    * @param parent
    *          the parent node, or <code>null</code> if this is the root node of a query tree.
    */
   ...
   /**
    * Returns the parent <code>QueryNode</code> or <code>null</code> if this is the root node of a
    * query tree.
    * 
    * @return the parent <code>QueryNode</code> or <code>null</code> if this is the root node of a
    *         query tree.
    */
   ...
   /**
    * Accepts a {@link QueryNodeVisitor} and calls the apropriate <code>visit</code> method on the
    * visitor depending on the concrete implementation of this <code>QueryNode</code>.
    * 
    * @param visitor
   ...
   /**
    * Returns <code>true</code> if <code>obj</code> is the same type of <code>QueryNode</code> as
    * <code>this</code> node and is equal to <code>this</code> node.
    * 
    * @param obj
    *          the reference object with which to compare.
    * @return <code>true</code> if <code>obj</code> is equal to <code>this</code>; <code>false</code>
    *         otherwise.
    */
   @Override
