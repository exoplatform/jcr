   ...
   implements Transformable
{
    ...
    */
   private static final Log log = ExoLogger.getLogger(WildcardQuery.class);
   ...
   /**
    * The standard multi term query to execute wildcard queries. This is only set if the pattern
    * matches less than {@link org.apache.lucene.search.BooleanQuery#maxClauseCount}.
    */
   ...
   /**
    * Either rewrites this query to a lucene MultiTermQuery or in case of a TooManyClauses exception
    * to a custom jackrabbit query implementation that uses a BitSet to collect all hits.
    * 
    * @param reader
    *          the index reader to use for the search.
      ...
      extends AbstractWeight
   {
      ...
      /**
       * Creates a new <code>WildcardQueryWeight</code> instance using <code>searcher</code>.
       * 
       * @param searcher
