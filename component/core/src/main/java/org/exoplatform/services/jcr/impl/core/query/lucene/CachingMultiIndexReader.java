 ...
 */
public final class CachingMultiIndexReader extends MultiReader implements HierarchyResolver,
    MultiIndexReader {
   ...
   * <code>-1</code> if <code>n</code> does not have a parent (<code>n</code> is
   * the root node).
   * 
  ...
  /**
   * Returns the DocId of the parent of <code>n</code> or {@link DocId#NULL} if
  ...
  /**
   * Returns the reader index for document <code>n</code>. Implementation copied
