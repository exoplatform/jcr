...
class DescendantSelfAxisQuery extends Query
{
   ...
   /**
    * If <code>true</code> this query acts on the descendant-or-self axis. If <code>false</code> this
    * query acts on the descendant axis.
    */
   ...
   /**
    * Creates a new <code>DescendantSelfAxisQuery</code> based on a <code>context</code> query and
    * filtering the <code>sub</code> query.
    * 
    * @param context
    ...
    *          the sub query.
    * @param includeSelf
    *          if <code>true</code> this query acts like a descendant-or-self axis. If
    *          <code>false</code> this query acts like a descendant axis.
    */
   ...
   {
      return "(DescendantSelfAxisQuery " + contextQuery.toString() + "->" + subQuery.toString() + ")";
   }
   ...
   private class DescendantSelfAxisWeight implements Weight
   {
      ...
      /**
       * Creates a new <code>DescendantSelfAxisWeight</code> instance using <code>searcher</code>.
       * 
       * @param searcher
   ...
   private class DescendantSelfAxisScorer extends Scorer
   {
       ...
       *          for index access.
       * @param hResolver
       *          the hierarchy resolver of <code>reader</code>.
       */
      ...
      /**
       * Returns <code>true</code> if <code>doc</code> is a valid match from the sub scorer against
       * the context hits. The caller must ensure that the context hits are calculated before this
       * method is called!
       * 
       * @param doc
       *          the document number.
