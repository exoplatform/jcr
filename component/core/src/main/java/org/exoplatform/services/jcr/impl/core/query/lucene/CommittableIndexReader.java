...
/**
 * Wraps an <code>IndexReader</code> and allows to commit changes without closing the reader.
 */
   ...
   extends FilterIndexReader
{
   ...
   /**
    * A modification count on this index reader. Initialied with {@link IndexReader#getVersion()} and
