   ...
   implements QueryConstants
{
   ...
   /**
    * Acts as an syntetic placeholder for a location step that matches any name. This is required
    * becase a JCR path does not allow a Name with a single '*' (star) character.
    */
   public static final InternalQName STAR_NAME_TEST = new InternalQName(Constants.NS_EXO_URI, "__star__");
   ...
   /**
    * If <code>true</code> this relation query node contains a value preceded with an unary minus.
    */
   private boolean unaryMinus;

   /**
    * The <code>long</code> value of the relation if this is a query is of type <code>long</code>
    */
   ...
   /**
    * The <code>double</code> value of the relation if this is a query is of type <code>double</code>
    */
   private double valueDouble;

   /**
    * The <code>String</code> value of the relation if this is a query is of type <code>String</code>
    */
   private String valueString;

   /**
    * The <code>Date</code> value of the relation if this is a query is of type <code>Date</code>
    */
   private Date valueDate;

   /**
    * The operation type of this relation. One of the operation values defined in
    * {@link QueryConstants}.
    */
   private int operation;

   /**
    * The value type of this relation. One of {@link #TYPE_DATE}, {@link #TYPE_DOUBLE},
    * {@link #TYPE_LONG}, {@link #TYPE_STRING}, {@link #TYPE_POSITION}.
    */
   private int type;

   /**
    * Creates a new <code>RelationQueryNode</code> without a type nor value assigned.
    * 
    * @param parent
   ...
   /**
    * If <code>b</code> is <code>true</code> then the value in this relation node contains a receding
    * unary minus.
    * 
    * @param b
    *          <code>true</code> if this relation contains a unary minus.
    */
   ...
   /**
    * Returns the name of the property in this relation query node. Please note that this method does
    * not return the full relative path that reference the property to match, but only the name of
    * the final name element of the path returned by {@link #getRelativePath()}.
    * 
    ...
    * 
    * @param relPath
    *          the relative path to a property.
   ...
   /**
    * Returns the <code>long</code> value if this relation if of type {@link #TYPE_LONG}.
    * 
   ...
   /**
    * Returns the <code>int</code> position index value if this relation is of type
    * {@link #TYPE_POSITION}.
    * 
   ...
   /**
    * Returns the <code>double</code> value if this relation if of type {@link #TYPE_DOUBLE}.
    * 
   ...
   /**
    * Returns the <code>String</code> value if this relation if of type {@link #TYPE_STRING}.
    * 
   ...
   /**
    * Returns the <code>Date</code> value if this relation if of type {@link #TYPE_DATE}.
    * 
