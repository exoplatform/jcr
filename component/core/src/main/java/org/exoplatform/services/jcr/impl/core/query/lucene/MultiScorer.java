   ...
   extends Scorer
{
   ...
   /**
    * Creates a new <code>MultiScorer</code> that spans multiple <code>scorers</code>.
    * 
    * @param similarity
    *          the similarity implementation that should be use.
    * @param scorers
    *          the sub scorers.
    * @param starts
    *          the document number start for each sub scorer.
    */
   ...
   /**
    * Returns the scorer index for document <code>n</code>. Implementation copied from lucene
    * MultiReader class.
    * 
    * @param n
    *          document number.
