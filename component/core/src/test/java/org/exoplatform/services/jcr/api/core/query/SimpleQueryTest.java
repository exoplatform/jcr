...
public class SimpleQueryTest extends AbstractQueryTest
{
   ...
   public void testSimpleQuerySQL1() throws Exception
   {
      ...
      String sql = "SELECT * FROM nt:base" + " WHERE jcr:path LIKE '" + testRoot + "/foo'" + " AND bla = 'bla'";
   ...
   public void testSimpleQuerySQL2() throws Exception
   {
      ...
      String sql = "SELECT * FROM nt:file" + " WHERE jcr:path LIKE '" + testRoot + "/%'" + " AND bla = 'bla'";
      Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
      QueryResult result = q.execute();
   ...
   public void testSimpleQuerySQL3() throws Exception
   {
      ...
      String sql = "SELECT * FROM nt:unstructured" + " WHERE jcr:path LIKE '" + testRoot + "/%'" + " AND bla = 'bla'";
      Query q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
      QueryResult result = q.execute();
   ...
   public void testLikePatternEscaped() throws Exception
   {
      ...
      sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot + "/%' AND value LIKE 'foo_bar'"; // matches
      // node3
      // and
      // node4
      q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
      ...
      sql = "SELECT * FROM nt:base WHERE jcr:path LIKE '" + testRoot + "/%' AND value LIKE 'foo%bar'"; // matches
      // all
      // nodes
      q = superuser.getWorkspace().getQueryManager().createQuery(sql, Query.SQL);
      result = q.execute();
