...
public class SkipDeletedNodesTest extends AbstractQueryTest
{
   ...
   /**
    * Executes a query with one session and removes a node from that query result with another
    * session.
    */
   ...
   /**
    * Executes a query with one session and removes a node from that query result with another
    * session. </p>This test is different from the other tests that it removes the node after another
    * session has called hasNext() to retrieve the node that gets deleted.
    */
