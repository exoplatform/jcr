...
public class AbstractQueryTest extends AbstractJCRTest
{
   ...
   /**
    * Checks if the <code>result</code> contains a number of <code>hits</code> and
    * <code>columns</code>.
    * 
    * @param result
    *          the <code>QueryResult</code>.
    ...
    *           if an error occurs while iterating over the result nodes.
    */
   protected void checkResult(QueryResult result, int hits, int columns) throws RepositoryException
   {
   ...
   /**
    * Executes the <code>xpath</code> query and checks the results against the specified
    * <code>nodes</code>.
    * 
    * @param xpath
    *          the xpath query.
   ...
   /**
    * Executes the <code>sql</code> query and checks the results against the specified
    * <code>nodes</code>.
    * 
    * @param sql
    *          the sql query.
