 ...
 */
public class TestSessionDataManager
   extends JcrImplBaseTest
{
   ...
   public void testItemReferencePool() throws Exception
   {
      ...
      TransientNodeData data =
               TransientNodeData.createNodeData(parent, new InternalQName(null, "testItemReferencePool1"),
      ...
      // add one more node
      data =
               TransientNodeData.createNodeData(parent, new InternalQName(null, "testItemReferencePool2"),
                        new InternalQName(Constants.NS_NT_URI, "unstructured"));
   ...
   public void testReadMethods() throws Exception
   {
      ...
      TransientNodeData someData =
               TransientNodeData.createNodeData(parent, new InternalQName(null, "testReadMethodsN1"),
                        new InternalQName(Constants.NS_NT_URI, "unstructured"));
      // NodeImpl node1 =
      ...
      // add one more node
      TransientNodeData data =
               TransientNodeData.createNodeData(parent, new InternalQName(null, "testReadMethodsN2"),
                        new InternalQName(Constants.NS_NT_URI, "unstructured"));
      NodeImpl node2 = (NodeImpl) modificationManager.update(ItemState.createAddedState(data), true);
   ...
   public void testCommitAndRefresh() throws Exception
   {
      ...
      TransientNodeData data1 =
               TransientNodeData.createNodeData(parent, new InternalQName(null, "testCommitAndRefreshN1"),
                        new InternalQName(Constants.NS_NT_URI, "unstructured"));
