...
Features of 1.14.6-GA
* Support GlusterFS
* Proper stopping the node while transactions in progress
* Adding and removing listeners in organization services are protected by RuntimePermission
...
1.14.6-GA tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12318628
