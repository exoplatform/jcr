JCR 1.14.0-CR3 release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Features of 1.14.0-CR3
* Allow to manage the JCR Cache from JMX
* Managed transactions and JCA support
* Possibility to specify custom mimetypes.properties for MimeTypeResolver
* Improved the methods Node.getProperties(String namePattern) and Node.getNodes(String namePattern) for getting only required items
...
1.14.0-CR3 tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12315932
