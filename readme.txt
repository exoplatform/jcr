JCR 1.14.3-GA release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Features of 1.14.3-GA
* JCR Data Consistency tool
* Support migration for the JCR locks stored in JBoss Cache
...
1.14.3-GA tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12318063
