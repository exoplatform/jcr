JCR 1.14.1-GA release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Features of 1.14.1-GA
* Resynchronization the lucene indexes of each cluster node at start up
* Caching JCR organization service's entities
...
1.14.1-GA tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12317452
https://jira.exoplatform.org/browse/JCR/fixforversion/14916
