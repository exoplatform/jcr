JCR 1.14.5-GA release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Features of 1.14.5-GA
* RPCService implementation based on JGroups 3
* Support default schema parameter for HibernateService
...
1.14.5-GA tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12318443
