JCR 1.12.12-GA release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Changes of 1.12.12-GA
=====================
Bug
    * [KER-181] - PortalContainer.getConfigurationXML() returns duplicated configuration
    * [JCR-1704] - Portlet crash and no preview available after save from Office 2010 in webdav

Task
    * [JCR-1695] - Improve using profile "value-storage-disabled"
    * [JCR-1705] - Allow to build the product using maven 3
    * [JCR-1709] - Source distribution of JCR services
...
Release includes:
* eXo Kernel 2.2.12-GA
* eXo Core 2.3.12-GA
* eXo WS 2.1.12-GA
* eXo JCR 1.12.12-GA

1.12.12-GA tasks:
https://jira.exoplatform.org/browse/KER/fixforversion/14922
https://jira.exoplatform.org/browse/JCR/fixforversion/14918
