JCR 1.14.4-GA release notes
===========================

eXoPlatform Java Content Repository (JSR-170) implementation and Extension services with clustering support.

Features of 1.14.4-GA
* Allow to use StandaloneContainer in web application with hot-redeploy
* Specific dialect which allows to use MyISAM instead of InnoDB for MySQL
...
1.14.4-GA tasks:
https://issues.jboss.org/browse/EXOJCR/fixforversion/12318128
