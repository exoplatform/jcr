...
public class TestAccess extends BaseStandaloneTest
{
   ...
   public void testAddMixinOwneable() throws Exception
   {
      ...
      Session session1 = repository.login(new CredentialsImpl("john", "exo".toCharArray()));
      ExtendedNode node1 = (ExtendedNode)session1.getRootNode().getNode("accessTestRoot/testSetOwneable");
   ...
   public void testAddMixinOwneable2() throws Exception
   {
      ...
      Session session = repository.login(new CredentialsImpl("mary", "exo".toCharArray()));
      ExtendedNode node1 = (ExtendedNode)session.getRootNode().getNode("accessTestRoot/testSetOwneable/adminNode");
