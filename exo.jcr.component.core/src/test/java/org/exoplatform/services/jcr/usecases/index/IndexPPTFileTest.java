 ...
 * @version $Id: IndexPPTFileTest.java 11907 2008-03-13 15:36:21Z ksm $
 * 
 *          The test for indexing a Microsoft PowerPoint .ppt file which contained within jcr:data
 *          property
 */

public class IndexPPTFileTest extends BaseUsecasesTest
{

   /**
    * The test for indexing a Microsoft PowerPoint .ppt file
    * 
    * @throws Exception
    */
   public void testIndexTextPlainFile() throws Exception
   {
      ...
      Query q;
      String xpath = "//*[jcr:contains(., 'PowerPoint file content')]";
