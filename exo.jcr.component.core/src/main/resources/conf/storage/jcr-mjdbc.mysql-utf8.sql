...
CREATE INDEX JCR_IDX_MITEM_NAME ON JCR_MITEM(I_CLASS, NAME(255))/
...
CREATE INDEX JCR_IDX_MVALUE_STORAGE_DESC ON JCR_MVALUE(PROPERTY_ID, STORAGE_DESC(255))/
...
CREATE TABLE JCR_MITEM_SEQ (
  ...
  CONSTRAINT JCR_PK_MITEM_SEQ PRIMARY KEY (name))ENGINE=InnoDB/
