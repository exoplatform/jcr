...
CREATE INDEX JCR_IDX_SITEM_NAME ON JCR_SITEM(I_CLASS, CONTAINER_NAME, NAME(255))/
...
CREATE INDEX JCR_IDX_SVALUE_STORAGE_DESC ON JCR_SVALUE(PROPERTY_ID, STORAGE_DESC(255))/
...
CREATE TABLE JCR_SITEM_SEQ (
  ...
  CONSTRAINT JCR_PK_SITEM_SEQ PRIMARY KEY (name))ENGINE=InnoDB/
