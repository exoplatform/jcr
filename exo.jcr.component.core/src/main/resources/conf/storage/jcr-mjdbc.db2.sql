...
CREATE SEQUENCE JCR_MITEM_SEQ  INCREMENT BY 1  NO MAXVALUE   NO CYCLE/
CREATE OR REPLACE FUNCTION JCR_MITEM_NEXT_VAL (nameSeq VARCHAR(120),newVal INTEGER, increment INTEGER)
RETURNS INT
LANGUAGE SQL
BEGIN
    ...
    SET query = 'Values NEXTVAL FOR  ' || nameSeq;
