...
public class MSXWordDocumentReader extends BaseDocumentReader
{
   ...
   /**
    * @see org.exoplatform.services.document.DocumentReader#getContentAsText(InputStream, String)
    */
   ...
   /**
    * @see org.exoplatform.services.document.DocumentReader#getProperties(InputStream)
    */
