...
EXO_OPTS="-Dexo.product.developing=true -Dexo.profiles=@exo.deploy.profile@ -Djava.net.preferIPv4Stack=true -Dcom.arjuna.ats.arjuna.objectstore.objectStoreDir=$PRGDIR/../temp -DObjectStoreEnvironmentBean.objectStoreDir=$PRGDIR/../temp"
