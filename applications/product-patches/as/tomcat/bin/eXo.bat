...
set EXO_OPTS=-Dexo.product.developing=true -Djava.net.preferIPv4Stack=true -Dcom.arjuna.ats.arjuna.objectstore.objectStoreDir=%TOMCAT_HOME%\temp -DObjectStoreEnvironmentBean.objectStoreDir=%TOMCAT_HOME%\temp
