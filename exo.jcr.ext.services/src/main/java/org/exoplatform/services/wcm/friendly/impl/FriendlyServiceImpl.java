...
public class FriendlyServiceImpl implements FriendlyService {
  ...
  public FriendlyServiceImpl(InitParams initParams) {
    friendlies = new LinkedHashMap<>();
    unfriendlies = new LinkedHashMap<>();
    if (initParams != null) {
      init(initParams);
    }
  }
  ...
  @Managed
  @ManagedDescription("Is the service enabled ?")
  public void setEnabled(@ManagedDescription("Enable/Disable this service ?")
  @ManagedName("isEnabled")
  boolean isEnabled) {
  ...
  public void addFriendly(@ManagedDescription("The friendly Uri")
  @ManagedName("friendlyUri")
  String friendlyUri,
                          @ManagedDescription("The unfriendly Uri")
                          @ManagedName("unfriendlyUri")
                          String unfriendlyUri) {
    if (!friendlies.containsKey(friendlyUri)) {
      if (LOG.isInfoEnabled())
        LOG.info("addFriendly::" + friendlyUri + "::" + unfriendlyUri + "::");
  ...
  public void removeFriendly(@ManagedDescription("The friendly Uri")
  @ManagedName("friendlyUri")
  String friendlyUri) {
    if (friendlies.containsKey(friendlyUri)) {
