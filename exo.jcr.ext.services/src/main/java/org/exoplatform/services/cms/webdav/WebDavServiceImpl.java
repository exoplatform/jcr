...
public class WebDavServiceImpl extends org.exoplatform.services.jcr.webdav.WebDavServiceImpl {
  ...
  private final MimeTypeResolver mimeTypeResolver;
                            ...
                            NodeFinder nodeFinder, AutoVersionService autoVersionService, ManageDriveService manageDriveService) throws Exception
   {
      ...
      this.listenerService = ExoContainerContext.getService(ListenerService.class);
  ...
  public Response put(@PathParam("repoName") String repoName,
    ...
    try {
      ...
      activityService = ExoContainerContext.getService(ActivityCommonService.class);
  ...
  public Response delete(@PathParam("repoName") String repoName,
    ...
    try {
      ...
      Node node = (Node)item;
      ListenerService listenerService =  ExoContainerContext.getService(ListenerService.class);
      ActivityCommonService activityService = ExoContainerContext.getService(ActivityCommonService.class);
